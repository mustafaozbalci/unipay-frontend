...
const AddBalance = ({ user, onBalanceUpdate, addNotification }) => {
    ...
    const handleFillFakeCard = () => {
        ...
        setExpireYear("2030");
        setCvc("123");
        addNotification("Fake kart bilgileri etkinleştirildi.", 3000);
    };
        ...
        <div className="add-balance-container">
            <div className="transparent-box">
                ...
                <button
                    ...
                    onClick={handleFillFakeCard}
                >
                    Fake Kart Aktifleştir
                </button>
                ...
                <form onSubmit={handleAddBalance}>
                    ...
                    <button className="submit">Pay Now & Add Balance</button>
                </form>
